...
class GraphTemplateLoader
{
    ...
    protected array $store = [
        ...
        'if_traffic' =>
            ...
            // Draw Percentiles
            . " LINE1:ifInBitsMaxPerc95#56A64B:'95 Percentile':dashes=3,5:skipscale"
            . " LINE1:ifInBitsMaxPerc99#56A64B:dashes=3,2:skipscale"
            ...
            . " LINE1:ifOutBitsMaxPerc95Mirrored#3274D9:dashes=3,5:skipscale"
            . " LINE1:ifOutBitsMaxPerc99Mirrored#3274D9:dashes=3,2:skipscale"
        ...
        'if_traffic_simple' =>
            ...
            // Draw Percentiles
            // . " LINE1:ifInBitsMaxPerc95#56A64B:dashes=3,5"
            // . " LINE1:ifInBitsMaxPerc99#56A64B:dashes=3,2:skipscale"
